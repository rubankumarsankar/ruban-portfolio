...
export default function GlobalViewportWrapper({ children }) {
  ...
  return (
    <div className="min-h-screen w-full bg-[#0B0F19] flex items-center justify-center overflow-hidden transition-all duration-500 p-0 lg:p-0">
      <motion.div
        animate={{ 
          width: getWidth(),
          height: viewportSize === "desktop" ? "100vh" : "90vh",
          borderRadius: viewportSize === "desktop" ? "0" : "32px",
          borderWidth: viewportSize === "desktop" ? "0" : "8px"
        }}
